...
export const services: ServiceItem[] = [
  {
    ...
    problem:
      'Freight moves often break down between handoffs, causing timeline drift and missed communication windows.',
    solution:
      'LogisticsFlow creates a single coordination lane across carriers, checkpoints, and account stakeholders so each handoff stays accountable.',
    benefits: [
  ...
  },
  {
    ...
    signal: 'Hub Ready',
    problem:
      'Growing teams outpace warehouse processes and lose control over outbound speed during high-volume periods.',
    solution:
      'We combine inventory handling standards with staged fulfillment workflows to keep throughput consistent without overstaffing.',
    benefits: [
  ...
  },
  {
    ...
    signal: 'Live Feed',
    problem:
      'Operations teams spend too much time chasing status updates from fragmented systems.',
    solution:
      'Our reporting layer consolidates shipment milestones into one stream with clear ownership and context.',
    benefits: [
  ...
  },
  {
    ...
    signal: 'Optimized',
    problem:
      'Route choices are often made reactively, increasing cost and delivery volatility.',
    solution:
      'We model route options against service-level targets and expected risk factors before dispatch.',
    benefits: [
  ...
  },
  {
    ...
    problem:
      'Cross-border shipments stall when documentation and customs communication are not synchronized.',
    solution:
      'We align shipment documentation and customs checkpoints with proactive exception handling.',
    benefits: [
  ...
  },
  {
    ...
    signal: 'Response SLA',
    problem:
      'Teams lose time when issue ownership is unclear and communication depends on generic inboxes.',
    solution:
      'Every account receives dedicated communication lanes and recurring review cycles tied to KPIs.',
    benefits: [
